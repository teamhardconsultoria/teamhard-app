...
const EDUZZ_LINKS: Record<string, string> = { monthly: 'https://chk.eduzz.com/40QROXQ39B', quarterly: 'https://chk.eduzz.com/60E2D8AKW3', legado: 'https://chk.eduzz.com/60E2QA4DW3' }
